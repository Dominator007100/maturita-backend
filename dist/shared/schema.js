...
exports.quizQuestions = exports.insertNewsArticleSchema = exports.newsArticles = exports.insertQuizSubmissionSchema = exports.quizSubmissions = exports.insertUserSchema = exports.users = exports.emailSubscriptions = void 0;
...
exports.emailSubscriptions = (0, pg_core_1.pgTable)("email_subscriptions", {
    ...
    confirmed: (0, pg_core_1.boolean)("confirmed").default(true).notNull(),
...
exports.quizSubmissions = (0, pg_core_1.pgTable)("quiz_submissions", {
    id: (0, pg_core_1.varchar)("id").primaryKey().default((0, drizzle_orm_1.sql) `gen_random_uuid()`),
    respondentName: (0, pg_core_1.text)("respondent_name").notNull(),
    respondentEmail: (0, pg_core_1.text)("respondent_email").notNull(),
    companyName: (0, pg_core_1.text)("company_name"),
    answers: (0, pg_core_1.jsonb)("answers").notNull().$type(),
    totalScore: (0, pg_core_1.integer)("total_score").notNull(),
    maxScore: (0, pg_core_1.integer)("max_score").notNull(),
    percentScore: (0, pg_core_1.integer)("percent_score").notNull(),
    riskLevel: (0, pg_core_1.text)("risk_level").notNull(),
    submittedAt: (0, pg_core_1.timestamp)("submitted_at").defaultNow().notNull(),
});
exports.insertQuizSubmissionSchema = (0, drizzle_zod_1.createInsertSchema)(exports.quizSubmissions).omit({
    id: true,
    submittedAt: true,
});
...
exports.quizQuestions = [
    ...
    },
    {
        ...
        explanation: "VPN znamená Virtual Private Network (virtuální privátní síť). Vytváří šifrovaný tunel mezi vaším zařízením a serverem, čímž chrání komunikaci a skrývá vaši IP adresu. Používá se pro bezpečný vzdálený přístup do firemní sítě i pro ochranu soukromí na veřejných Wi‑Fi sítích.",
        options: [
    ...
    },
    {
        id: "q3",
        type: "choice",
        category: "Hesla a autentizace",
        question: "Které heslo je nejbezpečnější?",
        explanation: "Bezpečné heslo by mělo být dlouhé alespoň 12 znaků, obsahovat kombinaci velkých a malých písmen, číslic a speciálních znaků a nemělo by obsahovat snadno uhodnutelné informace. Náhodně generovaná hesla, jako například „k9$Lm!pQ2x&vR7w“, jsou nejodolnější vůči útokům hrubou silou.",
        options: [
    ...
    },
    {
        ...
        explanation: "Vícefaktorová autentizace (MFA) vyžaduje ověření identity pomocí dvou či více nezávislých faktorů: něco, co víte (heslo), něco, co máte (telefon, token), a něco, čím jste (otisk prstu). Kombinace těchto faktorů výrazně zvyšuje bezpečnost.",
        options: [
    ...
    },
    {
        id: "q5",
        type: "choice",
        category: "Síťová bezpečnost",
        question: "Co označuje protokol HTTPS?",
        explanation: "HTTPS (HyperText Transfer Protocol Secure) je zabezpečená verze protokolu HTTP, která používá šifrování TLS/SSL pro ochranu dat přenášených mezi prohlížečem a webovým serverem. Poznáte jej podle ikony zámku v adresním řádku.",
        options: [
    ...
    },
    {
        ...
        explanation: "DDoS (Distributed Denial of Service) útok využívá velké množství infikovaných zařízení (botnet), která posílají obrovské množství požadavků na cílový server. Ten se následně zahltí a stává se nedostupným pro legitimní uživatele.",
        options: [
    ...
    },
    {
        id: "q7",
        type: "choice",
        category: "Hrozby a útoky",
        question: "Co je ransomware?",
        explanation: "Ransomware je typ škodlivého softwaru, který po infikování zařízení zašifruje data oběti a požaduje zaplacení výkupného za jejich dešifrování. Šíří se nejčastěji prostřednictvím phishingových e‑mailů nebo škodlivých příloh.",
        options: [
    ...
    },
    {
        ...
        explanation: "Sociální inženýrství je technika manipulace s lidmi za účelem získání důvěrných informací, přístupu k systémům nebo finančních prostředků. Útočníci využívají psychologické triky, jako je naléhavost, autorita nebo důvěra.",
        options: [
    ...
    },
    {
        ...
        explanation: "Pravidlo 3‑2‑1 je osvědčená strategie zálohování: 3 kopie dat, na 2 různých typech médií, z toho 1 kopie mimo hlavní pracoviště. Tento přístup chrání data před selháním hardwaru, krádeží, požárem i ransomwarem.",
        options: [
    ...
    },
    {
        ...
        explanation: "Šifrování je proces převodu čitelných dat do nečitelné podoby pomocí matematických algoritmů. Data lze zpět dešifrovat pouze pomocí správného klíče. Používá se k ochraně citlivých informací při přenosu i při ukládání.",
        options: [
    ...
    },
    {
        id: "q11",
        type: "choice",
        category: "Předpisy a standardy",
        question: "Co je NÚKIB v kontextu kybernetické bezpečnosti v ČR?",
        explanation: "NÚKIB (Národní úřad pro kybernetickou a informační bezpečnost) je ústřední orgán státní správy pro oblast kybernetické bezpečnosti v České republice. Koordinuje reakce na incidenty, vydává varování a doporučení a dohlíží na dodržování zákona o kybernetické bezpečnosti.",
        options: [
            { value: 0, label: "Antivirový program" },
    ...
    },
    {
        ...
        explanation: "Směrnice NIS2 stanovuje požadavky na kybernetickou bezpečnost pro důležité organizace a kritickou infrastrukturu. Rozšiřuje působnost původní směrnice NIS1 a zavádí přísnější sankce za nedodržení.",
        options: [
    ...
    },
    {
        ...
        phishingUrls: [
            {
                url: "https://www.mojebanka.cz/internetbanking",
                isPhishing: false,
                explanation: "Oficiální doména banky s HTTPS.",
            },
            {
                url: "https://www.m0jebanka-prihlaseni.com/login",
                isPhishing: true,
                explanation: "Podvržená doména: číslice 0 místo písmene „o“, jiná doménová koncovka (.com místo .cz).",
            },
            {
                url: "https://portal.gov.cz/sluzby",
                isPhishing: false,
                explanation: "Oficiální vládní portál České republiky.",
            },
        ],
        options: [
